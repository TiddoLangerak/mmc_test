...
#define CS_ON    (LPC_GPIO0->CLR |= (1<<20)) // p0.20 -> low    /* LPC4088 */
#define CS_OFF   (LPC_GPIO0->SET |= (1<<20)) // p0.20 -> high   /* LPC4088 */

#define TP_PENDOWN() ((LPC_GPIO2->PIN & (1<<15)) == 0)// & (1<<15))
...
{
  LPC_IOCON->P0_20 &= (~7);  /* LPC4088 */
  LPC_IOCON->P2_15 &= (~7);

  /* p0.20 pin as output (CS) */   /* LPC4088 */
  LPC_GPIO0->DIR |= (1<<20);       /* LPC4088 */

  /* p2.15 pin as input (TP_IRQ) */
  LPC_GPIO2->DIR &= ~(1<<15);
