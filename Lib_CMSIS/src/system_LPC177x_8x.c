...
//#else
#define PLL0CFG_Val           0x00000009  // 0x00000009 => 120Mhz, 0x00000013 => 80Mhz, 0x00000005 => 72Mhz
//#endif

#define PLL1_SETUP            1
#define PLL1CFG_Val           0x00000023
#define CCLKSEL_Val           0x00000101  // 0x00000101 => 120Mhz, 0x00000103 => 80Mhz
#define USBCLKSEL_Val         0x00000201
#define EMCCLKSEL_Val         0x00000001  // 0x1 => half CPU rate, 0x0 => same clock as CPU
#define SPIFISEL_Val          0x00000102
#define PCLKSEL_Val           0x00000002  // 0x2 => 120MHz, 0x3 => 80MHz
#define PCONP_Val             0x043887DE
...
void SystemInit (void)
{
  ...
  LPC_SC->RESERVED9 = SPIFISEL_Val;     /* SPIFI Clock Selection              */ /* LPC4088*/
