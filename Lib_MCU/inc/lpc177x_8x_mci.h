...
#define MCLKDIV_SLOW		90-1 /* 89 = 333,333Hz -> @60Mhz/(2*90) */  /* LPC4088 */
#define MCLKDIV_NORMAL		2-1  /* 1 = 15Mhz -> @60Mhz/(2*2) */      /* LPC4088 */
//#define MCLKDIV_NORMAL		3-1  /* 2 = 10Mhz -> @60Mhz/(2*3) */      /* LPC4088 */
#else
